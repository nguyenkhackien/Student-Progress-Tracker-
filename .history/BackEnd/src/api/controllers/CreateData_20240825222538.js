...
const { insertData2Majors, insertData2Subjects } = require("../../constants/String")
...
const createData = (req, res) => {
    ...
    insertData( curriculums, insertData2Majors, req, res )
    insertData(groupSubjects, insertData2Majors, req, res)
}
